...
def baixar_blob_se_existir(nome_arquivo_json, pasta):
    ...
    container_client = blob_service_client.get_container_client(f'{container_name_teste}/{pasta}')
...
def salvar_dados_margem(dados, nome_arquivo_json, pasta):
    # Converter o dicionário para JSON com formatação identada
    json_data = dados.to_json(orient='records', indent=4)
