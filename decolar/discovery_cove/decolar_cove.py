...
def decolar_discovery_cove(dados,data_atual):
    ...
    parques_mapping = {
        'O Discovery Cove é um parque exclusivo com o conceito de resort all inclusive, onde as famílias podem se divertir e colecionar momentos emocionantes em um ambiente tropical de tirar o fôlego': '1 Dia Discovery Cove + 14 Dias SeaWorld Orlando e Aquatica',
    ...
    # Salvar os dados
    salvar_dados_decolar(formatted_data, nome_arquivo, 'outros/discovery_cove', str(hora))
