...
async def juntarjsons_furafila(hour,data_atual):
    ...
    for empresa in empresas:
        for parque in parques:
            baixar_blob_se_existir(f'{parque}_{empresa}_{data_atual}.json', f'outros/furafila')
    ...
    salvar_dados_margem(df, nome_arquivo, 'outros/furafila/dados',nova_hora_formatada)
...
if __name__ == "__main__":
    ...
    asyncio.run(juntarjsons_furafila(hora_global,data_atual))
