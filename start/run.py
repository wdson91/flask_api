...
async def executar_ambos(hour, array_datas, data_atual):
    # try:
    #     await main_voupra(hour, array_datas, data_atual)  # Executa a função main_voupra com o argumento hour
    ...
    # try:
    #     await main_vmz(hour, array_datas, data_atual)  # Executa a função main_vmz com o argumento hour
    ...
    # try:
    #     await main_ml(hour, array_datas, data_atual)  # Executa a função main_ml com o argumento hour
