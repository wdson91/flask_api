...
async def coletar_precos_ml_seaworld(hora_global, array_datas,data_atual):
    ...
    try:
        for days in array_datas:
            ...
            logging.info(f"Coletando preços para {future_date} - ML SeaWorld")
            ...
            xpath_pairs = [
                ...
                ('//*[@id="root"]/div[2]/div[1]/div[3]/div[4]/div[1]/div[6]/div[2]/div[1]/button',
                 ...
                 '2 Dias 2 Parques com Refeição no Busch Gardens - SeaWorld Orlando'),
